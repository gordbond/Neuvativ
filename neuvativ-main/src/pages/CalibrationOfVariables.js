...
import CalibrationOfVariablesForm from '../components/CalibrationOfVariablesForm';
 ...
 * @returns 
 */
export function CalibrationOfVariables(){
          ...
          <>
            <div className="main-container">
                <div className="content-container">
                  <CalibrationOfVariablesForm/>
              </div>
            </div>
          </>
    );
    };
export default CalibrationOfVariables;